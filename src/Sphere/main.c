...
static const char connectionString[] = "HostName=Theshowerheads.azure-devices.net;DeviceId=AFB392A406D085727D64A7BF995514021AFEBEF47C5E783D622CF767B094F2E4D5147FD7FB02CEC91025E42AC85CCDBDB12D31320F6A83B5CC1E27C2466E199E;SharedAccessKey=HoISUn9N15Bfdy6bWek9hQUJKNYx0TORcJ4S64bNWCc=";
...
bool isDataReceivingStart = false;
// State variables
...
static void SendWaterDetails(char key, int i);
...
static void UartEventHandler(EventData* eventData)
{
	...
	if (bytesRead > 0) {
		...
		//if ((char*)receiveBuffer[1]=='S')
		//{
		//	isDataReceivingStart = true;
		//	Log_Debug("UART start received %d bytes: '%s'.\n", bytesRead, (char*)receiveBuffer);
		//	return;


		//}
		//if ((char*)receiveBuffer[1] == 'E')
		//{
		//	isDataReceivingStart = false;
		...
		//	int len = snprintf(tempBuffer, 20, "%3.2f", (char*)receiveBuffer);
		//	Log_Debug("UART received %d bytes: '%s'.\n", bytesRead, (char*)receiveBuffer);
		...
		//connect to SendTelemetry
		Log_Debug("UART received %d bytes: '%s'.\n", bytesRead, (char*)receiveBuffer);
		//SendTelemetry("RunTime", "10");
		//SendTelemetry("ActiveTime", "5");
	}
